                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="product__details-content">
                                 ...
                                 <div class="product__details-price">
                                    <span class="old-price">Rs 30.35</span>
                                    <span class="new-price">Rs 19.25</span>
                                 </div>
               ...
               <div class="header-to-main d-none d-sm-flex">
                  ...
                  <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                     ...
                     <div class="header-lang-item tp-header-currency">
                        <span class="header-currency-toggle text-white" id="header-currency-toggle">RS</span>
                        <ul>
                     ...
                     <div class="header-lang-item tp-header-setting">
                        ...
                        <ul>
                           <li>
                              <a class="furniture-clr-hover" href="login.php">Authentication</a>
                              <a class="furniture-clr-hover" href="register.php"></a>
                           </li>
                           <li>
                              <a class="furniture-clr-hover" href="myprofile.php">My Profile</a>
                           </li>
                           <li>
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-thumb-wrapper-4 p-relative">
                                 <div class="banner-thumb-4 p-relative z-index-1">
                                    <img src="assets/imgs/furniture/banner/chair1.png" alt="image">
                                 </div>
                     ...
                     <div class="container">
                        <div class="row g-5 align-self-end">
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-thumb-wrapper-4 p-relative">
                                 <div class="banner-thumb-4 p-relative z-index-1">
                                    <img src="assets/imgs/furniture/banner/chair2.png" alt="image">
                                 </div>
                                 <div class="furniture-circle d-none d-lg-block">
                                    <img src="assets/imgs/furniture/banner/circle.png" alt="">
                                 </div>
                     ...
                     <div class="container">
                        <div class="row g-5 align-self-end">
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-thumb-wrapper-4 p-relative">
                                 <div class="banner-thumb-4 p-relative z-index-1">
                                    <img src="assets/imgs/furniture/banner/chair3.png" alt="image">
                                 </div>
                                 <div class="furniture-circle d-none d-lg-block">
                                    <img src="assets/imgs/furniture/banner/circle.png" alt="">
                                 </div>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="product-item furniture__product">
                                 ...
                                 <div class="product-content">
                                    <h4 class="product-title"><a href="product-details.php">Alexander roll Arm
                                          sofa</a></h4>
                                    ...
                                    <div class="product-price">
                                       <span class="product-new-price">Rs 150.00</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="product-item furniture__product">
                                 ...
                                 <div class="product-content">
                                    <h4 class="product-title"><a href="product-details.php">Brasslegged
                                          Armchair</a></h4>
                                    <div class="user-rating">
                                       <i class="fal fa-star"></i>
                                       <i class="fal fa-star"></i>
                           ...
                           <div class="swiper-slide">
                              <div class="product-item furniture__product">
                                 ...
                                 <div class="product-content">
                                    <h4 class="product-title"><a href="product-details.php">Leather Chair</a>
                                    </h4>
                                    <div class="user-rating">
                                       <i class="fal fa-star"></i>
                                       <i class="fal fa-star"></i>
                                    ...
                                    <div class="product-price">
                                       <span class="product-new-price">Rs 200.00</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="product-item furniture__product">
                                 ...
                                 <div class="product-content">
                                    ...
                                    <div class="product-price">
                                       <span class="product-new-price">Rs 49.00</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item furniture__product">
                              ...
                              <div class="product-content">
                                 ...
                                 <div class="product-price">
                                    <span class="product-new-price">Rs 190.00</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item furniture__product">
                              ...
                              <div class="product-content">
                                 ...
                                 <div class="product-price">
                                    <span class="product-new-price">Rs 300.00</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item furniture__product">
                              ...
                              <div class="product-content">
                                 ...
                                 <div class="product-price">
                                    <span class="product-new-price">Rs 129.00</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item furniture__product">
                              ...
                              <div class="product-content">
                                 ...
                                 <div class="product-price">
                                    <span class="product-new-price">Rs 80.00</span>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <div class="col-xxl-6 col-xl-6 col-lg-6">
                  <div class="blog-item-4 furniture__blog-item">
                     <div class="blog-content-4">
                        ...
                        <h4 class="blog-title">
                           <a href="blog-details.php" class="text-capitalize">arrangement that's nearly perfect.</a>
                        </h4>
               ...
               <div class="col-xxl-6 col-xl-6 col-lg-6">
                  <div class="blog-item-4 furniture__blog-item">
                     <div class="blog-content-4">
                        ...
                        <h4 class="blog-title">
                           <a href="blog-details.php" class="text-capitalize">Eworkstation arrangement that's</a>
                        </h4>
                        <a class="round-link" href="blog-details.php"><i class="fa-regular fa-angle-right"></i></a>
                     </div>
               ...
               <div class="footer-grid-3">
                  <div class="footer-widget-4">
                     <div class="footer-logo mb-35">
                        <a href="index.php"><img src="assets/imgs/furniture/logo/logo-light.svg"
